...
const m3uLink = "https://api.github.com/repos/MDuymazz/Py/contents/m3u8/playlist.m3u"; // Burayı düzelttim
...
#EXTINF:-1 tvg-name="SATIN AL" tvg-logo="https://cdn-icons-png.flaticon.com/512/1828/1828925.png" group-title="İLETİŞİME GEÇİN.", IPTV SÜRESİ UZATMAK İÇİN BİZİMLE İLETİŞİME GEÇİN!
...
http://iptv-info.local/expire`;
    ...
    const m3uJson = await m3uResponse.json();
    let m3uData = atob(m3uJson.content);
